...
public class Lienzo extends javax.swing.JPanel implements MouseListener {
    ...
    public static Point pI, pF; //Esto puede ser una redundancia, pero lo puse así para no confundir con los de la arista
    int n = 0;
...
//                            getEnlaces().add(new aristas(p1.x, p1.y, p2.x, p2.y, 1));
                            ...
                            System.out.println("YA PINTO ESA MONDA"); //lol
                            p1 = null;
                            p2 = null;
                        }
                    }
