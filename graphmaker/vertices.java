...
public class vertices {
    ...
    String nb;  //el nombre del vertice para la matriz de recorridos
    boolean vst; //visitado
    ArrayList<vertices> ady; //adyaciente
    private int id;
    int d = 40;
    int x, y;

    public vertices(String name, int id, String s, int x, int y) {
        this.name = name;
        this.id = id;
        vst = false;
        this.nb = s;
        this.ady = new ArrayList<vertices>();
        setX(x);
        setY(y);
    }
